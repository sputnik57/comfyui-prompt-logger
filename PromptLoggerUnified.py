...
class PromptLoggerUnified:
    ...
    RETURN_TYPES = (
        "STRING", "STRING", "SAMPLER", "SCHEDULER", "INT", "FLOAT", "INT", "BOOLEAN", "FLOAT")
    RETURN_NAMES = ("prompt", "filename", "sampler", "scheduler", "steps", "cfg", "seed", "control_after_generate", "denoise")
...
NODE_DISPLAY_NAME_MAPPINGS = {"PromptLoggerUnified": "Prompt Logger Unified"}
